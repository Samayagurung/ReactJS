...
function App() {
  ...
  return (
    <>
      <NavMenu></NavMenu>
      <Routes>
        <Route path="Product1" element={<Product1 productX={products}></Product1>}>
        </Route>
        <Route path="student1" element={<Student1 studentX={students}></Student1>} >
          </Route>
      </Routes>
      {/* <h2 className="text-center text-primary mt-3">Students Detail</h2> */}
      <h2 className="text-center text-info mt-3">Product Detail</h2>
